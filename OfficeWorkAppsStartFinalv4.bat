...
IF /I "%TaskTodo%" == "Y" (
    ...
    FOR /L %%X IN (1,1,10) DO (
        ...
        /IM sublime_text.exe /IM Firefox.exe /IM AnyDesk.exe /IM Slack.exe /IM Teams.exe /IM PWRISOVM.exe /IM openvpn-gui.exe ^
...
rem SET ChromeStartDir="%ProgramFiles%\Google\Chrome\Application"
rem SET ChromeAppProxyDir="%ProgramFiles%\Google\Chrome\Application"
rem PUSHD %ChromeStartDir% && START chrome.exe
rem START chrome_proxy.exe --profile-directory=Default --app-id=pkooggnaalmfkidjmlhoelhdllpphaga && POPD
